...
impl Rule for PromptDescriptionMatchesName {
    ...
    fn rationale(&self) -> &'static str {
        "Descriptions should add information beyond the prompt's identifier."
    }
    fn severity(&self) -> Severity {
        Severity::Warning
    }
...
impl Rule for PromptDescriptionTooShort {
    ...
    fn rationale(&self) -> &'static str {
        "Very short descriptions do not give the agent enough signal to pick the right prompt."
    }
    fn severity(&self) -> Severity {
        Severity::Warning
    }
...
/// (not per argument) to keep reports terse.
...
impl Rule for PromptArgumentMissingDescription {
    ...
    fn rationale(&self) -> &'static str {
        "Agents have no way to fill prompt arguments correctly if each is undocumented."
    }
    fn severity(&self) -> Severity {
        Severity::Warning
    }
